...
// Usando customPrefix para que el comando se ejecute con el prefijo
handler.customPrefix = /kevinff/i; // Este es el prefijo que usas para el comando
handler.help = ["kevinff"];
handler.tags = ["juegos"];
handler.command = /^kevinff$/i; // No usa el punto
handler.exp = 20;
