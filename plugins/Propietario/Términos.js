...
let oi = `${pesan}`
let teks = `${oi}\n`
teks += `1) 𝖭𝗈 𝗁𝖺𝗀𝖺 𝗇𝗂 𝗂𝗇𝗍𝖾𝗇𝗍𝖾 𝗆𝖺𝗇𝖽𝖺𝗋 𝗅𝗂𝗇𝗄𝗌, 𝗅𝗅𝖺𝗆𝖺𝖽𝖺𝗌 𝗈 𝖽𝗆 𝗁𝖺𝖼𝗂𝖺 𝖾𝗅 𝗉𝗋𝗂𝗏𝖺𝖽𝗈 𝖽𝖾 𝙗𝙪𝙪 𝙗𝙤𝙩 𝙤𝙛𝙞𝙘𝙞𝙖𝙡.

2) 𝖤𝗅 𝗌𝗍𝖺𝖿𝖿 𝖽𝖾 BUU 𝗇𝗈 𝗌𝖾 𝗁𝖺𝖼𝖾 𝗋𝖾𝗌𝗉𝗈𝗇𝗌𝖺𝖻𝗅𝖾 𝗉𝗈𝗋 𝖾𝗅 𝗆𝖺𝗅 𝗎𝗌𝗈 𝖽𝖾𝗅 𝖻𝗈𝗍. 
