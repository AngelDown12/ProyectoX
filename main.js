...
printQRInTerminal: opcion == '1' ? true : methodCodeQR ? true : false,
mobile: MethodMobile, 
browser: opcion == '1' ? ['𝗕𝘂𝘂 𝗕𝗼𝘁 𝗢𝗳𝗶𝗰𝗶𝗮𝗹', '𝗕𝘂𝘂 𝗕𝗼𝘁 𝗢𝗳𝗶𝗰𝗶𝗮𝗹', '𝗕𝘂𝘂 𝗕𝗼𝘁 𝗢𝗳𝗶𝗰𝗶𝗮𝗹'] : methodCodeQR ? ['𝗕𝘂𝘂 𝗕𝗼𝘁 𝗢𝗳𝗶𝗰𝗶𝗮𝗹', '𝗕𝘂𝘂 𝗕𝗼𝘁 𝗢𝗳𝗶𝗰𝗶𝗮𝗹', '𝗕𝘂𝘂 𝗕𝗼𝘁 𝗢𝗳𝗶𝗰𝗶𝗮𝗹'] : ["𝗕𝘂𝘂 𝗕𝗼𝘁 𝗢𝗳𝗶𝗰𝗶𝗮𝗹", "𝗕𝘂𝘂 𝗕𝗼𝘁 𝗢𝗳𝗶𝗰𝗶𝗮𝗹", "𝗕𝘂𝘂 𝗕𝗼𝘁 𝗢𝗳𝗶𝗰𝗶𝗮𝗹"],
auth: {
creds: state.creds,
keys: makeCacheableSignalKeyStore(state.keys, Pino({ level: "fatal" }).child({ level: "fatal" })),
},
